...
public class surum extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button_danhmuc = findViewById(R.id.bt_danhmuc);
        Button button_sanpham = findViewById(R.id.bt_sanpham);
        ...
        RecyclerView.ItemDecoration itemDecorationn = new DividerItemDecoration(this,DividerItemDecoration.HORIZONTAL);
        rcv_sanpham.addItemDecoration(itemDecorationn);
        button_sanpham.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!isRecyclerViewVisible) {
                    ...
                    SanPham_Adapter sanPham_Adapter = new SanPham_Adapter();
    ...
    private List<SanPham> getSanPham() {
        ...
        sanPhamList.add(new SanPham("300.000d",R.drawable.img_image12,"430.000d"));
        sanPhamList.add(new SanPham("300.000d",R.drawable.img_image13_138x127,"280.000d"));
